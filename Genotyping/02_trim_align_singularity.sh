#!/bin/bash
#SBATCH --chdir=./
#SBATCH --job-name=<species>_bam
#SBATCH --partition quanah
#SBATCH --nodes=1 --ntasks=12
#SBATCH --time=48:00:00
#SBATCH --mem-per-cpu=8G
#SBATCH --array=1-<number of samples for this species>
...
basename_array=$( head -n${SLURM_ARRAY_TASK_ID} ${workdir}/00fastq/SampleID.txt | tail -n1 )

# define the reference genome
refgenome=/lustre/work/gbehrend/ETH/GCF_003957565.2_bTaeGut1.4.pri_genomic.fasta

# run bbduk
/lustre/work/jmanthey/bbmap/bbduk.sh in1=${workdir}/00fastq/${basename_array}_R1.fastq.gz in2=${workdir}/00fastq/${basename_array}_R2.fastq.gz out1=${workdir}/01_cleaned/${basename_array}_R1.fastq.gz out2=${workdir}/01_cleaned/${basename_array}_R2.fastq.gz minlen=50 ftl=10 qtrim=rl trimq=10 ktrim=r k=25 mink=7 ref=/lustre/work/jmanthey/bbmap/resources/adapters.fa hdist=1 tbo tpe
